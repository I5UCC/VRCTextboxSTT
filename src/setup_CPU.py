...
packages = ["av", "certifi", "charset_normalizer", "click", "colorama", "ctranslate2", "faster_whisper", "filelock", "flask", "functorch", "huggingface_hub", "idna", "itsdangerous", "jinja2", "keyboard", "kthread", "markupsafe", "mpmath", "networkx", "numpy", "openvr", "packaging", "PIL", "psutil", "pyaudio", "pythonosc", "regex", "requests", "speech_recognition", "sympy", "tokenizers", "torch", "torchgen", "tqdm", "transformers", "urllib3", "waitress", "werkzeug", "yaml"]
