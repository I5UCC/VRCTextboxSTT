...
class SettingsWindow:
    def __init__(self, conf: config_struct, config_path, script_path, get_coodinates):
        ...
        self.label_timeout_time.grid(row=3, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.entry_timeout_time.grid(row=3, column=5, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.label_hold_time.grid(row=4, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.entry_hold_time.grid(row=4, column=5, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.label_phrase_time_limit.grid(row=5, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.entry_phrase_time_limit.grid(row=5, column=5, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.label_mic.grid(row=6, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.opt_mic.grid(row=6, column=5, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.label_word_replacements.grid(row=7, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.button_word_replacements.grid(row=7, column=6, padx=2, pady=7, sticky='ws')
        ...
        self.label_use_textbox.grid(row=8, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.label_use_kat.grid(row=9, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.label_use_both.grid(row=10, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.label_emotes.grid(row=11, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.button_emotes.grid(row=11, column=6, padx=2, pady=7, sticky='ws')
