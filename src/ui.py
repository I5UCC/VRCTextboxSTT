...
class SettingsWindow:
    def __init__(self, conf: config_struct, config_path, script_path, get_coodinates):
        ...
        self.tkui.minsize(920, 560)
        self.tkui.maxsize(920, 560)
        self.tkui.resizable(False, False)
        self.tkui.configure(bg="#333333")
        ...
        self.label_autocorrect.grid(row=7, column=0, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.opt_autocorrect.grid(row=7, column=1, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.label_hotkey.grid(row=8, column=0, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.button_hotkey.grid(row=8, column=1, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.label_mode.grid(row=9, column=0, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.opt_mode.grid(row=9, column=1, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.label_det.grid(row=10, column=0, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.opt_det.grid(row=10, column=1, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.label_energy_threshold.grid(row=11, column=0, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.entry_energy_threshold.grid(row=11, column=1, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.button_refresh.grid(row=11, column=2, padx=2, pady=3, sticky='ws')
        ...
        self.label_pause_threshold.grid(row=12, column=0, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.entry_pause_threshold.grid(row=12, column=1, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.label_audio_feedback.grid(row=0, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.button_settings_overlay.grid(row=1, column=6, padx=2, pady=7, sticky='ws')
        ...
        self.button_obs_source.grid(row=2, column=6, padx=2, pady=7, sticky='ws')
        ...
        self.label_text_timeout_time.grid(row=3, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.entry_text_timeout_time.grid(row=3, column=5, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.label_timeout_time.grid(row=4, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.entry_timeout_time.grid(row=4, column=5, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.label_hold_time.grid(row=5, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.entry_hold_time.grid(row=5, column=5, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.label_phrase_time_limit.grid(row=6, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.entry_phrase_time_limit.grid(row=6, column=5, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.label_mic.grid(row=7, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.opt_mic.grid(row=7, column=5, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.label_word_replacements.grid(row=8, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.opt_enable_replacement.grid(row=8, column=5, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.button_word_replacements.grid(row=8, column=6, padx=2, pady=7, sticky='ws')
        ...
        self.label_use_textbox.grid(row=9, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.opt_use_textbox.grid(row=9, column=5, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.label_use_kat.grid(row=10, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.opt_use_kat.grid(row=10, column=5, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.label_use_both.grid(row=11, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.opt_use_both.grid(row=11, column=5, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.label_emotes.grid(row=12, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.opt_emotes.grid(row=12, column=5, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.button_emotes.grid(row=12, column=6, padx=2, pady=7, sticky='ws')
    ...
    def reset_to_default(self):
        ...
        self.entry_text_timeout_time.delete(0, _config.text_timeout)
        self.entry_timeout_time.delete(0, tk.END)
