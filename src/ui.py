...
class SettingsWindow:
    def __init__(self, conf: config_struct, config_path, script_path, get_coodinates):
        ...
        self.label_audio_feedback.grid(row=1, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.opt_audio_feedback.grid(row=1, column=5, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.button_audio_feedback.grid(row=1, column=6, padx=2, pady=7, sticky='ws')
        ...
        self.label_enable_overlay.grid(row=2, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.opt_enable_overlay.grid(row=2, column=5, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.button_settings_overlay.grid(row=2, column=6, padx=2, pady=7, sticky='ws')
        ...
        self.label_obs_source.grid(row=3, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.opt_obs_source.grid(row=3, column=5, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.button_obs_source.grid(row=3, column=6, padx=2, pady=7, sticky='ws')
        ...
        self.label_text_timeout_time.grid(row=4, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.entry_text_timeout_time.grid(row=4, column=5, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.label_timeout_time.grid(row=5, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.entry_timeout_time.grid(row=5, column=5, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.label_hold_time.grid(row=6, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.entry_hold_time.grid(row=6, column=5, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.label_phrase_time_limit.grid(row=7, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.entry_phrase_time_limit.grid(row=7, column=5, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.label_mic.grid(row=8, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.label_word_replacements.grid(row=9, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.opt_enable_replacement.grid(row=9, column=5, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.button_word_replacements.grid(row=9, column=6, padx=2, pady=7, sticky='ws')
        ...
        self.label_use_textbox.grid(row=10, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.opt_use_textbox.grid(row=10, column=5, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.label_use_kat.grid(row=11, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.opt_use_kat.grid(row=11, column=5, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.label_use_both.grid(row=12, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.opt_use_both.grid(row=12, column=5, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.label_emotes.grid(row=13, column=4, padx=PADX_L, pady=PADY, sticky='es')
        ...
        self.opt_emotes.grid(row=13, column=5, padx=PADX_R, pady=PADY, sticky='ws')
        ...
        self.button_emotes.grid(row=13, column=6, padx=2, pady=7, sticky='ws')
